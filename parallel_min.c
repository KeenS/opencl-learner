...
main(int argc, char **argv)
{
  ...
  for(dev = 0; dev < NDEVS; dev++) {
    ...
    clSetKernelArg(minp, 2, sizeof(void *), (void *) NULL);
    clSetKernelArg(minp, 3, sizeof(void *), (void *) &dbg_buf);
    clSetKernelArg(minp, 4, sizeof(void *), (void *) &num_src_items);
    clSetKernelArg(minp, 5, sizeof(void *), (void *) &dev);
